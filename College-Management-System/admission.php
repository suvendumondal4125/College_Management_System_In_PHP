		...
		<div class="row">
			<div class="col-md-12 w-100 p-5">
				...
				<p class="tet-justify">
					<ol>
						<li>
							That I have read and understood the directives of the Hon’ble Supreme Court of India on antiragging and the measures proposed to be taken in the above references (Available at
							http://www.hithaldia.in). 
						</li>
						<li>
						...
						<li>
							That I have not been found or charged for my involvement in any kind of ragging in the past.
						...
						<li>
							That I shall not resort to ragging in any form at any place and shall abide by the rules/laws
							prescribed by the Courts, Govt. of India and the Institute authorities for the purpose from time to time. 
						</li>
						<li>
							in case I become involved in any manner in any form of ragging case I am liable for any
							...
							<ul>
								...
								<li>Debarring from appearing in any test / examination or other evaluation process
									Withholding results </li>
								<li>Debarring from representing the institution in any regional, national or international
									meet, tournament, youth festival, etc. </li>
								...
								<li>Expulsion from the institution and consequent debarring from admission to any other
									institution. </li>
								<li>Collective punishment: when the persons committing or abetting the crime of ragging
									are not identified, the institution shall resort to collective punishment as a deterrent to ensure community pressure on the potential raggers.</li>
							</ul>
						</li>
					</ol>
				</p>
